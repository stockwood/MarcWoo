...
//
     ...
     * Create the frame.
     */
    public GuiFrame(int width, int height, SimLoop sm) {
        ...
        start_B.setIcon(new ImageIcon(GuiFrame.class.getResource("/gui/graphics/run.png")));
        toolBar.add(start_B);
        ...
        pause_B.setIcon(new ImageIcon(GuiFrame.class.getResource("/gui/graphics/pause.png")));
        ...
        toolBar.add(reset_b);
        reset_b.setIcon(new ImageIcon(GuiFrame.class.getResource("/gui/graphics/reset.png")));
